...
//   **********************/
//  
//  Array * MedianFilter(Image & img, ParaSet & imgPara, Array *original, int depth, int rad){ 
//    
...
//   **********************/
//  
//  Array * LocalMedianFilter(Image & img, ParaSet & imgPara, Array * original, int depth, int filterRad){
//    
...
//   **********************/
//  
//  Array * ExtremeLocalMedianFilter(Image & img, ParaSet & imgPara, Array * original, int depth){
//    
//    uint32 *orig    = AUINT32(original);
//    Array  *median = Make_Array_With_Shape(PLAIN_KIND, UINT32_TYPE, Coord2(original->dims[1], original->dims[0]));
//    uint32 *med    = AUINT32(median);
...
//    Use_Extend_Boundary();
//    
//    Frame * f = Make_Frame(original,Coord2(3,3),Coord2(1, 1));
//    Histogram * h = Make_Histogram(UVAL,depth,ValU(1),ValU(0));
//    
//    
//    Place_Frame(f,0);
...
//      Empty_Histogram(h);
//      Histagain_Array(h,f,0);
//      if (abs(orig[p] - Percentile2Bin(h,.5)) > 3) {
//        med[p] = Percentile2Bin(h,.5);
//      } else {
//        med[p] = orig[p];
//      }
...
//   **********************/
//  
//  Array * Filtering (Image & img, ParaSet & imgPara, Array * original, int depth, int filterSizes []) {
