...
//   ***************/
//  
//  Array * MaxProjection (Image & img, ParaSet & imgPara){
//    Indx_Type q;
//    int       zmax;
//    
...
//   ***************/
//  
//  Array * MaxProjection_16bit (Image & img, ParaSet & imgPara){
//    Indx_Type q;
//    int       zmax;
//    
...
//   ***************/
//  
//  Array * Substack_UsingMask(Image & img, ParaSet & imgPara, Array * median, bool onlyTopPixel){
//    
//    Array * substack = Make_Array(PLAIN_KIND, UINT8_TYPE, 3, img.GetImage()->dims);
//    Array_Op_Scalar(substack, MUL_OP, UINT8_TYPE, ValU(0));
//    
...
//    //}
//    
//    int stackSize = std::min(abs(imgPara.distance2-imgPara.distance1)+1, img.GetDepth());
//    
//    Use_Extend_Boundary();
...
//        p = (z*img.GetHeight()+y*imgPara.radius)*img.GetWidth()+x*imgPara.radius;
//        Place_Frame(f, p);
...
//            zmax = z;
//            
//            for (int d = imgPara.distance1; d <= imgPara.distance2; d++) {
...
//   ***************/
//  
//  Array * Substack_UsingMask_16bit(Image & img, ParaSet & imgPara, Array * median, bool onlyTopPixel){
//    
//    uint32   *map = AUINT32(median);
//    
//    /******
...
//     */
//    
//    Array * img_8bit = Make_Array(PLAIN_KIND, UINT8_TYPE, 2, img.GetImage()->dims);
//    uint8 * val = AUINT8(img_8bit);
//    uint8 * val16bit = AUINT8(img_8bit);
//    for (Indx_Type p=0; p < img.GetArea(); p++) {
//      val[p] = (uint8) val16bit[p];
//    }
//    
//    /******
//     * Otherwise
...
//   ***************/
//  
//  Array *MaxIndices(Image & img, ParaSet & imgPara, Array *maxim){
//    
//    Indx_Type q;
//    int       best, zmax;
//    
...
//   ***************/
//  
//  Array *MaxIndices_16bit(Image & img, ParaSet & imgPara, Array *maxim){
//    
//    Indx_Type q;
//    int       best, zmax;
//    
