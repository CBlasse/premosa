...
static float idata[10000];
static float tdata[10000];
static float cdata[10000];
...
double compute_iave(int k, int size, int idx, float *data)
{ double ave;
  int    i, p, n, s;
...
double compute_idev(int k, int size, int idx, float *data, double ave)
{ double dev;
  int    i, p, n, s;
...
double compute_tave(int k, int size, int idx, float *data)
{ double ave;
  int    i, p, n, s, q;
...
double compute_tdev(int k, int size, int idx, float *data, double ave)
{ double dev;
  int    i, p, n, s, q;
