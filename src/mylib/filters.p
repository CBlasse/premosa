...
static D_Scheme _Matlab = { NULL, NULL };
static D_Scheme _Sobel  = { NULL, NULL };
static D_Scheme _Iso3   = { NULL, NULL };
static D_Scheme _Iso5   = { NULL, NULL };
static D_Scheme _Iso7   = { NULL, NULL };
