...
inline Value VALU( uint64 u) { Value v; v.uval = u; return v; }
inline Value VALI(  int64 i) { Value v; v.ival = i; return v; }
inline Value VALF(float64 f) { Value v; v.fval = f; return v; }
