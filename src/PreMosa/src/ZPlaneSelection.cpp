...
namespace ZPlane {
  ...
  Array * PlaneSelection_8bit (Image & img, ImgParameter & imgPara, Array *maxim, Array *index){
    ...
    Array * PlaneSelection_16bit (Image & img, ImgParameter & imgPara, Array *maxim, Array *index){
  ...
  Array * PlaneSelection_DoubleRadius (Image & img, ImgParameter & imgPara, Array *maxim, Array *index, int rad){
  ...
  Array * SelectPlanes_Variance_8bit(Image & img, ImgParameter & imgPara, Array * substack){
    ...
    Array * SelectPlanes_Variance_16bit(Image & img, ImgParameter & imgPara, Array * substack){
  ...
  Array * SelectPlanes_Entropy(Image & img, ImgParameter & imgPara, Array * substack){
  ...
  Array * SelectPlanes_LOG(Image & img, ImgParameter & imgPara, Array * substack){
  ...
  Array * SelectPlanes_LOG_basal(Image & img, ImgParameter & imgPara, Array * substack){
