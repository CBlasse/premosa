...
namespace Interpolation{
  ...
  Array *InterpolateCorners(Image & img, ImgParameter & imgPara, Array *median){
    ...
    Array *InterpolatePlanes_8bit(Image & img, ImgParameter & imgPara, Array *maxim, Array *corners){
    ...
    Array *InterpolatePlanes_16bit(Image & img, ImgParameter & imgPara, Array *maxim, Array *corners){
